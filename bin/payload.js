...
(function() {
  ...
  getReqPayload = function(origReqPayload, contentType) {
    var reqPayload;
    if ((contentType != null ? contentType.indexOf('application/json') : void 0) === 0 || (contentType != null ? contentType.indexOf('application/x-www-form-urlencoded') : void 0) === 0 || (contentType != null ? contentType.indexOf('multipart/form-data') : void 0) === 0) {
